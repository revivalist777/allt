...
This document provides guidelines for internationalization of the allt Coin software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to allt network</numerusform>
            <numerusform>%n active connections to allt network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `allt_en.ts` remains unchanged.
