...
The build script we'll be using is contained in the allt github repository ([contrib/gitian-build.py](https://github.com/alltransfercoin/allt/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the allt repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/allt/allt/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, allt-detached-sigs, and allt GitHub repos.
