...
from fake_stake.base_test import allt_FakeStakeTest

class zalltwrappedSerialsTest(allt_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zallts..." % DENOM_TO_USE)
