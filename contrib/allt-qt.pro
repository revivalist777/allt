...
RESOURCES += src/qt/allt.qrc src/qt/allt_locale.qrc

TRANSLATIONS += src/qt/locale/allt_bg.ts \
                src/qt/locale/allt_de.ts \
                src/qt/locale/allt_en.ts \
                src/qt/locale/allt_es.ts \
                src/qt/locale/allt_fi.ts \
                src/qt/locale/allt_fr.ts \
                src/qt/locale/allt_it.ts \
                src/qt/locale/allt_ja.ts \
                src/qt/locale/allt_pl.ts \
                src/qt/locale/allt_pt.ts \
                src/qt/locale/allt_ru.ts \
                src/qt/locale/allt_sk.ts \
                src/qt/locale/allt_sv.ts \
                src/qt/locale/allt_vi.ts \
                src/qt/locale/allt_zh_CN.ts \
                src/qt/locale/allt_zh_TW.ts
