// Copyright (c) 2017-2018 The allt developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef allt_zalltWALLET_H
#define allt_zalltWALLET_H
...
public:
    CzalltWallet(std::string strWalletFile);
    ...
    void GenerateDeterministiczallt(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedTozallt(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
