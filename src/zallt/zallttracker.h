...
#ifndef allt_zalltTRACKER_H
#define allt_zalltTRACKER_H
...
public:
    CzalltTracker(std::string strWalletFile);
    ~CzalltTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzalltWallet* zalltWallet = NULL);
