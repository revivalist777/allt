...
/** Utility functions used by the allt Qt UI.
 */
namespace GUIUtil
{
...
// Render allt addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool iszallt = false);
...
// Parse "allt:" URI into recipient object, return true on successful parsing
