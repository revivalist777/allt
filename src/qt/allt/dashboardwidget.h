...
#include "qt/allt/furabstractlistitemdelegate.h"
...
#include "config/allt-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalallt = 0;
    qint64 totalzallt = 0;
    QList<qreal> valuesallt;
    QList<qreal> valueszallt;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(alltGUI* _window);
    ~DashboardWidget();
