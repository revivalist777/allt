...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, alltGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, alltGUI *gui, double posX = 3);
