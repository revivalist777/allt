...
#include "qt/allt/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/allt/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(alltGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to alltGUI::handleRestart()
