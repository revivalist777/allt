...
#include "qt/allt/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/allt/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(alltGUI* _window, QWidget *parent) :
