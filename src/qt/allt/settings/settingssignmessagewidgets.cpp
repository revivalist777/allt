...
#include "qt/allt/settings/settingssignmessagewidgets.h"
#include "qt/allt/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(alltGUI* _window, QWidget *parent) :
