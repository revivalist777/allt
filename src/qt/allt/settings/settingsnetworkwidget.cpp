...
#include "qt/allt/settings/settingsnetworkwidget.h"
#include "qt/allt/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/allt/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(alltGUI* _window, QWidget *parent) :
