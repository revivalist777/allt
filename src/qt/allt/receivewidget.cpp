...
#include "qt/allt/forms/ui_receivewidget.h"
...
#include "qt/allt/addressholder.h"
...
ReceiveWidget::ReceiveWidget(alltGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive allt."));
