...
#ifndef allt_CORE_NEW_GUI_alltGUI_H
#define allt_CORE_NEW_GUI_alltGUI_H
...
#include "qt/allt/navmenuwidget.h"
#include "qt/allt/topbar.h"
#include "qt/allt/dashboardwidget.h"
#include "qt/allt/send.h"
#include "qt/allt/receivewidget.h"
#include "qt/allt/addresseswidget.h"
#include "qt/allt/privacywidget.h"
#include "qt/allt/coldstakingwidget.h"
#include "qt/allt/masternodeswidget.h"
#include "qt/allt/snackbar.h"
...
/**
  allt GUI main class. This class represents the main window of the allt UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class alltGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit alltGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~alltGUI();
...
#endif //allt_CORE_NEW_GUI_alltGUI_H
