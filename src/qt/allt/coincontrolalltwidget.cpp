...
#include "qt/allt/coincontrolalltwidget.h"
#include "qt/allt/forms/ui_coincontrolalltwidget.h"

CoinControlalltWidget::CoinControlalltWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlalltWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select allt Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("allt");
    ...
    ui->labelValueAfter->setText("0.00 allt");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 allt");
    ui->labelValueFee->setText("0.00 allt");
...
CoinControlalltWidget::~CoinControlalltWidget()
{
    delete ui;
}
