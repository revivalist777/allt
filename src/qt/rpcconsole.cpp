                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzalltPathCustom = GetArg("-zalltbackuppath", "");
    ...
    if(!strzalltPathCustom.empty()) {
        ui->wallet_customzalltbackuppath->setText(QString::fromStdString(strzalltPathCustom));
        ui->wallet_customzalltbackuppath_label->setVisible(true);
        ui->wallet_customzalltbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzalltPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the allt RPC console.") + "<br>" +
