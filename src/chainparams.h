 ...
 * allt system. There are three: the main network on which people trade goods
...
public:
    ...
    int alltBadBlockTime() const { return nalltBadBlockTime; }
    int alltBadBlocknBits() const { return nalltBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nalltBadBlockTime;
    unsigned int nalltBadBlocknBits;
