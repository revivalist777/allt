/* src/config/allt-config.h.  Generated from allt-config.h.in by configure.  */
/* src/config/allt-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef allt_CONFIG_H

#define allt_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/alltransfercoin/allt/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "allt Coin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "allt Coin 1.0.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "allt"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://alltcoin.online/"
