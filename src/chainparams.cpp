...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x000005570c719ffd7d804cff151944c10edbd19af1696abeb9a36536094e3d87"))
	(5900, uint256("52dd53eff122f143a05b6fc2e2c5a7bf5cb114621781992514b41f8c054570a5"))
	(6260, uint256("959066dc67b2403bd4d058f7e180d7638133cd02ef196373bb8e091339049c81"))

	;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1652159870, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 25878;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // allt starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 250;
        nalltBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nalltBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        ...
        nEnforceNewSporkKey = 1652159870; //!> Sporks signed after , 02 02 2021 12:00:00 GMT must use the new spork key
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "allt our solution";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1652159870;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 8298658;

        hashGenesisBlock = genesis.GetHash(); 
		 
	assert(hashGenesisBlock == uint256("000005570c719ffd7d804cff151944c10edbd19af1696abeb9a36536094e3d87"));
        assert(genesis.hashMerkleRoot == uint256("e2593cad4d47aa929f0d320da52c71ddb4b5e42bdc0c10d9d1e371099e5b29b2"));

        vSeeds.push_back(CDNSSeedData("139.59.163.70", "139.59.163.70"));
        vSeeds.push_back(CDNSSeedData("144.202.39.42", "144.202.39.42"));
        vSeeds.push_back(CDNSSeedData("104.238.185.97", "104.238.185.97"));		
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zallt to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nalltBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nalltBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet allt addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet allt script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet allt BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet allt BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet allt BIP44 coin type is '1' (All coin's testnet default)
        ...
        strObfuscationPoolDummyAddress = "alltfGRkekRyDRNeJiLtYVEbvhXrNbmox";
