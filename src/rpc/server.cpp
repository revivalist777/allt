...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* allt features */
        {"allt", "listmasternodes", &listmasternodes, true, true, false},
        {"allt", "getmasternodecount", &getmasternodecount, true, true, false},
        {"allt", "masternodeconnect", &masternodeconnect, true, true, false},
        {"allt", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"allt", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"allt", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"allt", "masternodecurrent", &masternodecurrent, true, true, false},
        {"allt", "masternodedebug", &masternodedebug, true, true, false},
        {"allt", "startmasternode", &startmasternode, true, true, false},
        {"allt", "createmasternodekey", &createmasternodekey, true, true, false},
        {"allt", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"allt", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"allt", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"allt", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"allt", "getmasternodescores", &getmasternodescores, true, true, false},
        {"allt", "preparebudget", &preparebudget, true, true, false},
        {"allt", "submitbudget", &submitbudget, true, true, false},
        {"allt", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"allt", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"allt", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"allt", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"allt", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"allt", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"allt", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"allt", "checkbudgets", &checkbudgets, true, true, false},
        {"allt", "mnsync", &mnsync, true, true, false},
        {"allt", "spork", &spork, true, true, false},
        {"allt", "getpoolinfo", &getpoolinfo, true, true, false},
        {"allt", "getcollateral", &getcollateral, true, true, false},
...
{
    return "> allt-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:25877/\n";
}
