Contributing to allt Coin
============================

The allt Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/alltransfercoin/allt/blob/master/doc/translation_process.md)
...
The following applies to code changes to the allt Coin project, and is not to be
confused with overall allt Network Protocol consensus changes.

Whether a pull request is merged into allt Coin rests with the project merge
...
Patches that change allt consensus rules are considerably more involved than
...
Where a patchset proposes to change the allt consensus, it must have been
...
The project leader is the release manager for each allt Coin release.
